...
% Last Modified by GUIDE v2.5 31-Mar-2013 04:43:01
...
elseif(strcmp(handles.colorFilter,'mannual'))
    handles.redValue = get(handles.slider1,'Value');
    handles.greenValue = get(handles.slider2,'Value');
    handles.blueValue = get(handles.slider3,'Value');
    handles.displayImage = generateEditImage(hObject,handles,3);
end
displayImage(hObject,handles)
guidata(hObject, handles);
...
if(~strcmp(handles.colorFilter,'mannual'))
